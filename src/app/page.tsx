  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-white'>
      <div className='max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8'>
        <nav className='mb-4 flex justify-end gap-2'><Link href='/sound-effects' className='rounded-lg border border-blue-200 bg-white px-4 py-2 text-sm font-medium text-blue-700 hover:bg-blue-50'>Sound Effects</Link><Link href='/svg-library' className='rounded-lg border border-blue-200 bg-white px-4 py-2 text-sm font-medium text-blue-700 hover:bg-blue-50'>SVG Library</Link></nav>
        {error ? (
